...
export const InvoicePackaging = props => {
    ...
    <Document>
      <Page style={commercialStyles.page}>
        <View style={commercialStyles.mainContainer}>
          ...
          <Text style={commercialStyles.title}>PACKING LIST</Text>
          ...
          <View style={commercialStyles.table}>
            ...
            >
              ...
              <View style={[commercialStyles.tableCol, { width: "53%" }]}>
              ...
              <View style={[commercialStyles.tableCol, { width: "12%" }]}>
                <Text style={commercialStyles.tableCell}>19. Net</Text>
                <Text style={[commercialStyles.tableCell, { paddingLeft: 10 }]}>
                  Weight
                </Text>
                <Text style={[commercialStyles.tableCell, { paddingLeft: 10 }]}>
                  in kgs.
              ...
              >
                <Text style={commercialStyles.tableCell}>20. Gross</Text>
                <Text style={[commercialStyles.tableCell, { paddingLeft: 10 }]}>
                  Weight
                </Text>
                <Text style={[commercialStyles.tableCell, { paddingLeft: 10 }]}>
            ...
            >
              ...
              >
                <Text style={commercialStyles.tableCell}></Text>
              </View>
              <View
                style={[
                  commercialStyles.tableCol,
            ...
            >
              ...
              >
                <Text style={commercialStyles.tableCell}>3036 ROLLS</Text>
              </View>
              <View
                style={[
                  commercialStyles.tableCol,
              ...
              >
                ...
                <Text style={commercialStyles.tableCell}>Kgs.</Text>
              </View>
              <View
                style={[
                  commercialStyles.tableCol,
            ...
            <View style={commercialStyles.tableRow}>
              ...
              >
                ...
                <Text
                  style={[commercialStyles.tableCell, { paddingBottom: 10 }]}
                >
                  The Exporter of products covered by this document (custom
                  identification no. AEZFS3495Q) declares that, except where
                  otherwise clearly indicated, these products are of "INDIAN
                  ORIGIN" preferencial origin in accordance with the rules of
                  origin of the developing countries trading scheme of the UK
              ...
              >
                ...
                >
                  21, For SMARTWRAP FILM EXTRUSIONS LLP
                </Text>
              </View>
            </View>
          </View>
