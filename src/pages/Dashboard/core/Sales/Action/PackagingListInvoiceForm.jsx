...
const PackagingListInvoiceForm = () => {
  ...
  return (
    <div>
      <Breadcrumb title="Smart-wrap" breadcrumbItem="Packaging List" />
          ...
          <Card>
            <CardBody className="border-bottom">
                ...
                <form onSubmit={handleSubmit(data => onSubmit(data, false))}>
                  ...
                  <section className="mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block">Total Net Weight:</label>
                        <input
                          type="number"
                      ...
                      <div>
                        <label className="block">Total Gross Weight:</label>
                        <input
                          type="number"
              ...
              <div className="flex gap-2 justify-end">
                ...
                <button
                  className="px-4 py-2 bg-primary text-white rounded-md hover:bg-primary hover:opacity-80"
                >
                  Next
                </button>
              </div>
...
export default PackagingListInvoiceForm
