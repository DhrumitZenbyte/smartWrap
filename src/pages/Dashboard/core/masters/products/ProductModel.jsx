...
const ProductModal = ({ isOpen, onClose, onAddProduct }) => {
  ...
  const [saleUnit, setSaleUnit] = useState("")
  const [purchaseUnit, setPurchaseUnit] = useState("")
  const [waterabsorbstation, setWaterabsorbstation] = useState("")
  ...
  const handleSubmit = e => {
    ...
    const newProduct = {
      ...
      water_absorption: waterabsorbstation || 0,
      field: field || "N/A",
    }
    onAddProduct(newProduct)
    onClose();
        ...
        <div className="bg-white p-6 rounded shadow-lg w-96">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                value={waterabsorbstation}
                onChange={e => setWaterabsorbstation(e.target.value)}
                className="w-full px-3 py-2 border rounded"
              />
            </div>
            <div className="mb-4">
